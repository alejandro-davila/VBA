Sub VBA_Challenge_Assignment2_ADavila()
...
ws.Activate
    ...
    Dim Header As Integer
        ...
        Next i
            ...
            'Section_D - This section helps find the Total_Volume without being affected by Section_C.
        SummaryTable = 2
        ...
        SolutionTable = Cells(Rows.Count, "I").End(xlUp).Row
        Range("J2:J" & SolutionTable).NumberFormat = "0.00"
        ...
        Next n
            ...
            'Section_F - This section answers and formats the Max,Min,Max Volume solution table.
